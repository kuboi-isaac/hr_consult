    ...
    r(
        ...
        slice: function (t, e) {
            ...
            for (
            var o = c(t, n), s = c(e, n), l = a(s - o), f = new Array(l), p = 0;
            p < l;
            p++
            )
    ...
    n(59)('replace', 2, function (t, e, n, d) {
        ...
        function (t, e) {
            ...
            } else T = v(k, p, j, L, A, e)
            j >= w && ((S += p.slice(w, j) + T), (w = j + k.length))
            }
            return S + p.slice(w)
        }
        ]
    ...
    ;(o.nextTick = function (t) {
        ...
        s.push(new d(t, e)), 1 !== s.length || l || a(h)
    }),
    ...
    t.exports = function (t) {
        ...
        if (t && n != n) {
            ...
            for (; s > l; l++) if ((t || l in u) && u[l] === n) return t || l || 0
        return !t && -1
        }
    }
    },
    ...
    t.exports = function (t, e, n, y, m, g, b) {
        ...
        _ = ('Array' == e && E.entries) || A
        if (
        (_ &&
            (w = l(_.call(new t()))) !== Object.prototype &&
            w.next &&
            (s(w, k, !0), r || 'function' == typeof w[f] || c(w, f, v)),
        j &&
            A &&
            A.name !== d &&
            ((L = !0),
    ...
    ;(function (t, e, n) {
        ...
        function T (t, e) {
            ...
            if (
                ...
                C = _.length
                for (b.pop(), a = 0; a < C; a++) t[_[a]] = g[_[a]]
                for (; '..' === E[0]; ) b.pop(), E.shift()
                t.path =
                ('/' !== e.charAt(0) ? b.join('/') : '') + '/' + E.join('/')
            }
    ...
    t.exports = function (t) {
        ...
        for (var n, a = i(e), u = o(a), s = u.length, l = 0, f = []; s > l; )
            (n = u[l++]), (r && !c.call(a, n)) || f.push(t ? [n, a[n]] : a[n])
        return f
        }
    }
    },
    ...
    var r = n(2),
        ...
        s(function () {
            ...
            ? function (t, e, n) {
                var r = T(G, e)
                r && delete G[e], _(t, e, n), r && t !== G && _(G, e, r)
            }
            : _,
        W = function (t) {
        ...
        return (
            !(this === G && o($, t) && !o(z, t)) &&
            (!(e || !o(this, t) || !o($, t) || (o(this, q) && this[q][t])) || e)
        )
        },
        X = function (t, e) {
        if (((t = S(t)), (e = w(e, !0)), t !== G || !o($, e) || o(z, e))) {
            var n = T(t, e)
            return (
            !n || !o($, e) || (o(t, q) && t[q][e]) || (n.enumerable = !0), n
            )
        }
        },
        Z = function (t) {
    ...
    U ||
        ...
        (I = function () {
            ...
            return i && B && H(G, t, { configurable: !0, set: e }), W(t)
        }).prototype,
        'toString',
        function () {
            return this._k
    ...
    var c = new (n.n(r).a)(),
        ...
        document
            ...
            t.addEventListener('change', function (t) {
                b(t.target.name, t.target.value), O(t.target.name, t.target.value)
            })
            })
        },
        v = function () {
        ...
        if ('theme' === t) {
            ...
            .setAttribute('href', 'css/'.concat(n, '.css')),
        ...
        S = function () {
        k('theme'), k('layout'), k('sidebarPosition'), k('sidebarLayout')
        },
        w = function (t) {
    ...
    var j = new MutationObserver(function () {
        ...
        (Object.keys(c.query).length > 0
            ...
            Object.entries(c.query).forEach(function (t) {
                ...
                n = e[0],
                r = e[1]
                l[n] && l[n].includes(r) && (b(n, r), O(n, r))
            }))
            : g(),
        j.disconnect())
    })
